...
@implementation MKCSEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKGatewayMiniTwo", @"MKCSEasyShowView", @"cs_refreshIcon.png");
    }
    return _refreshIcon;
}
