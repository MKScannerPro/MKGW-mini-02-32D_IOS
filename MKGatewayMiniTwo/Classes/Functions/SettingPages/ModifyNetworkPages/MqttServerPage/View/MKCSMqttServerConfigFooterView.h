//
//  MKCSMqttServerConfigFooterView.h
...
@interface MKCSMqttServerConfigFooterViewModel : NSObject
...
@protocol MKCSMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKCSMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKCSMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCSMqttServerConfigFooterViewDelegate>delegate;
