...
@implementation MKCSMqttServerLwtViewModel
@end

@interface MKCSMqttServerLwtView ()
...
@implementation MKCSMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKGatewayMiniTwo", @"MKCSMqttServerLwtView", @"cs_switchSelectedIcon.png") : LOADICON(@"MKGatewayMiniTwo", @"MKCSMqttServerLwtView", @"cs_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKGatewayMiniTwo", @"MKCSMqttServerLwtView", @"cs_switchSelectedIcon.png") : LOADICON(@"MKGatewayMiniTwo", @"MKCSMqttServerLwtView", @"cs_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKCSMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCSMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKGatewayMiniTwo", @"MKCSMqttServerLwtView", @"cs_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKGatewayMiniTwo", @"MKCSMqttServerLwtView", @"cs_switchUnselectedIcon.png") forState:UIControlStateNormal];
