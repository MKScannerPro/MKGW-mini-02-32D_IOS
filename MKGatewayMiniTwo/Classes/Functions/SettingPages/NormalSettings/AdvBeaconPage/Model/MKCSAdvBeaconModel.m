...
@interface MKCSAdvBeaconParamsModel : NSObject<cs_advertiseBeaconProtocol>
...
@implementation MKCSAdvBeaconParamsModel
@end


@interface MKCSAdvBeaconModel ()
...
@implementation MKCSAdvBeaconModel
...
- (BOOL)configAdvBeaconDatas {
    ...
    MKCSAdvBeaconParamsModel *dataModel = [[MKCSAdvBeaconParamsModel alloc] init];
    ...
    [MKCSMQTTInterface cs_configAdvertiseBeaconParams:dataModel macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
