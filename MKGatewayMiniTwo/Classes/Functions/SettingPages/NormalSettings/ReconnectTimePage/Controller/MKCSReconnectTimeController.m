...
@interface MKCSReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCSReconnectTimeModel *dataModel;

@end

@implementation MKCSReconnectTimeController

- (void)dealloc {
    NSLog(@"MKCSReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniTwo", @"MKCSReconnectTimeController", @"cs_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCSReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
