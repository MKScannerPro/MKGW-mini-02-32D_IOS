...
@interface MKCSCommunicateModel ()
...
@implementation MKCSCommunicateModel
...
- (BOOL)readCommunicateTimeout {
    ...
    [MKCSMQTTInterface cs_readCommunicateTimeoutWithMacAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
