...
@interface MKCSNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCSNetworkStatusModel *dataModel;

@end

@implementation MKCSNetworkStatusController

- (void)dealloc {
    NSLog(@"MKCSNetworkStatusController销毁");
}
...
- (MKCSNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
