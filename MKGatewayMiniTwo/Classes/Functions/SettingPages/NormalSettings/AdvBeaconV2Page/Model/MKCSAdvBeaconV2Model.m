...
@interface MKCSAdvBeaconParamsV2Model : NSObject<cs_advertiseBeaconV2Protocol>
...
@implementation MKCSAdvBeaconParamsV2Model
@end

@interface MKCSAdvBeaconV2Model ()
...
@implementation MKCSAdvBeaconV2Model
...
- (BOOL)readAdvBeaconDatas {
    ...
    [MKCSMQTTInterface cs_readAdvertiseBeaconParamsWithMacAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvBeaconDatas {
    ...
    MKCSAdvBeaconParamsV2Model *dataModel = [[MKCSAdvBeaconParamsV2Model alloc] init];
    ...
    [MKCSMQTTInterface cs_configV2AdvertiseBeaconParams:dataModel macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
