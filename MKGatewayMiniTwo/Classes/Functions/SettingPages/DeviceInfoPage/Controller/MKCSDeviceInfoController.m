...
@property (nonatomic, strong)MKCSDeviceInfoModel *dataModel;

@end

@implementation MKCSDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCSDeviceInfoController销毁");
}
...
- (MKCSDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
