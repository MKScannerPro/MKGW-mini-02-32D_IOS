...
@interface MKCSSettingForV2Controller ()<UITableViewDelegate,
...
@implementation MKCSSettingForV2Controller

- (void)dealloc {
    NSLog(@"MKCSSettingForV2Controller销毁");
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && indexPath.row == 4) {
        ...
        MKCSAdvBeaconV2Controller *vc = [[MKCSAdvBeaconV2Controller alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
...
- (void)loadSection0Datas {
    ...
    cellModel3.leftMsg = @"Communication timeout";
    ...
    cellModel5.leftMsg = @"Advertisement settings";
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniTwo", @"MKCSSettingForV2Controller", @"cs_editIcon.png") forState:UIControlStateNormal];
