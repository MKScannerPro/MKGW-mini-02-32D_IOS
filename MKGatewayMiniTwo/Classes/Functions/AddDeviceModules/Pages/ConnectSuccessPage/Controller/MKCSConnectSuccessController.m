//
//  MKCSConnectSuccessController.m
...
@interface MKCSConnectSuccessController ()
...
@implementation MKCSConnectSuccessController

- (void)dealloc {
    NSLog(@"MKCSConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKCSDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cs_addNewDeviceSuccessNotification"
                                                            object:nil
