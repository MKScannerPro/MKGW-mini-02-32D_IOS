//
//  MKCSDeviceParamsListController.m
...
@interface MKCSDeviceParamsListController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKCSDeviceParamsListController

- (void)dealloc {
    NSLog(@"MKCSDeviceParamsListController销毁");
...
- (void)viewDidLoad {
    ...
    [MKCSDeviceMQTTParamsModel shared].deviceModel.deviceType = self.deviceType;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1 && indexPath.row == 2) {
        //Advertise iBeacon
        MKCSBleAdvBeaconController *vc = [[MKCSBleAdvBeaconController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 1 && indexPath.row == 3) {
        //Device Information
        MKCSBleDeviceInfoController *vc = [[MKCSBleDeviceInfoController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
}
