//
//  MKCSBleAdvBeaconV2Controller.m
...
@interface MKCSBleAdvBeaconV2Controller ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCSBleAdvBeaconV2Model *dataModel;

@end

@implementation MKCSBleAdvBeaconV2Controller

- (void)dealloc {
    NSLog(@"MKCSBleAdvBeaconV2Controller销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniTwo", @"MKCSBleAdvBeaconV2Controller", @"cs_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCSBleAdvBeaconV2Model *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSBleAdvBeaconV2Model alloc] init];
    }
    return _dataModel;
}
