...
@interface MKCSBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCSBleDeviceInfoModel *dataModel;

@end

@implementation MKCSBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCSBleDeviceInfoController销毁");
...
- (MKCSBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
