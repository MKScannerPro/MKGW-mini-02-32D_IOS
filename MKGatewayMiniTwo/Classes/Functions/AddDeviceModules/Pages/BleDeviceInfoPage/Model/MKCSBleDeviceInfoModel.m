...
@interface MKCSBleDeviceInfoModel ()
...
@implementation MKCSBleDeviceInfoModel
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKCSInterface cs_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
