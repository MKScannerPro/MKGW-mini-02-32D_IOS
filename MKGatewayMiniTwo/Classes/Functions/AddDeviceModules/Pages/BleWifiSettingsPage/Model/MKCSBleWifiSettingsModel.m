...
@interface MKCSBleWifiSettingsModel ()
...
@implementation MKCSBleWifiSettingsModel
...
- (BOOL)readSecurityType {
    ...
    [MKCSInterface cs_readWIFISecurityWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSecurityType {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFISecurity:self.security sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiSSID {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFISSIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiSSID {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFISSID:self.ssid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiPassword {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFIPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiPassword {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIPassword:self.wifiPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPType {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFIEAPTypeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPType {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIEAPType:self.eapType sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPUsername {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFIEAPUsernameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPUsername {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIEAPUsername:self.eapUserName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPPassword {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFIEAPPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPPassword {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIEAPPassword:self.eapPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPDomainID {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFIEAPDomainIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPDomainID {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIEAPDomainID:self.domainID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readVerifyServer {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFIVerifyServerStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configVerifyServer {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIVerifyServerStatus:self.verifyServer sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKCSInterface cs_configWIFICAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKCSInterface cs_configWIFIClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKCSInterface cs_configWIFIClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiDHCPStatus {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFIDHCPStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiDHCPStatus {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIDHCPStatus:self.wifi_dhcp sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiIpAddress {
    __block BOOL success = NO;
    [MKCSInterface cs_readWIFINetworkIpInfosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiIpAddress {
    __block BOOL success = NO;
    [MKCSInterface cs_configWIFIIpAddress:self.wifi_ip
                                     mask:self.wifi_mask
