//
//  MKCSBleDeviceInfoV2Controller.m
...
@interface MKCSBleDeviceInfoV2Controller ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCSBleDeviceInfoV2Model *dataModel;

@end

@implementation MKCSBleDeviceInfoV2Controller

- (void)dealloc {
    NSLog(@"MKCSBleDeviceInfoV2Controller销毁");
...
- (MKCSBleDeviceInfoV2Model *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSBleDeviceInfoV2Model alloc] init];
    }
    return _dataModel;
}
