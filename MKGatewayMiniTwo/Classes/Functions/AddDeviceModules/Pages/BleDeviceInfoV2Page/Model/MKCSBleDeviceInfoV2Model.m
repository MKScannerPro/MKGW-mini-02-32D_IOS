...
@interface MKCSBleDeviceInfoV2Model ()
...
@implementation MKCSBleDeviceInfoV2Model
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKCSInterface cs_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKCSInterface cs_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBleFirmware {
    __block BOOL success = NO;
    [MKCSInterface cs_readBLEFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKCSInterface cs_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKCSInterface cs_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKCSInterface cs_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readWifiFirmware {
    __block BOOL success = NO;
    [MKCSInterface cs_readWifiFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
