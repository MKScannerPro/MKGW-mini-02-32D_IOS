//
//  MKCSUploadDataOptionController.m
...
@interface MKCSUploadDataOptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCSUploadDataOptionModel *dataModel;

@end

@implementation MKCSUploadDataOptionController

- (void)dealloc {
    NSLog(@"MKCSUploadDataOptionController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniTwo", @"MKCSUploadDataOptionController", @"cs_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCSUploadDataOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSUploadDataOptionModel alloc] init];
    }
    return _dataModel;
}
