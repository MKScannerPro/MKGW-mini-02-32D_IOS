//
//  MKCSFilterByRawDataV2Controller.m
...
@interface MKCSFilterByRawDataV2Controller ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCSFilterByRawDataV2Model *dataModel;

@end

@implementation MKCSFilterByRawDataV2Controller

- (void)dealloc {
    NSLog(@"MKCSFilterByRawDataV2Controller销毁");
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 2 && indexPath.row == 4) {
        //Nano Beacon
        MKCSFilterByNanoBeaconController *vc = [[MKCSFilterByNanoBeaconController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
...
- (MKCSFilterByRawDataV2Model *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSFilterByRawDataV2Model alloc] init];
    }
    return _dataModel;
}
