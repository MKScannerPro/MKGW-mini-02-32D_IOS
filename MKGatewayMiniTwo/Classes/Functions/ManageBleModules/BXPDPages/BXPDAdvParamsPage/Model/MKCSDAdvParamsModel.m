...
@implementation MKCSDAdvParamsModel
...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKCSMQTTInterface cs_readBXPDAdvParamsWithBleMacAddress:bleMac macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
