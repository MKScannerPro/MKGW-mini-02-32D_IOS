//
//  MKCSBXPCTHDataSampleRateModel.m
...
@interface MKCSBXPCTHDataSampleRateModel ()
...
@implementation MKCSBXPCTHDataSampleRateModel
...
- (BOOL)readTHDataSampleRate:(NSString *)bleMac {
    ...
    [MKCSMQTTInterface cs_readBXPCTHDataSampleRateWithBleMacAddress:bleMac macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTHDataSampleRate:(NSString *)bleMac {
    ...
    [MKCSMQTTInterface cs_configBXPCSampleRate:[self.self.sampleRate integerValue] bleMac:bleMac macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
