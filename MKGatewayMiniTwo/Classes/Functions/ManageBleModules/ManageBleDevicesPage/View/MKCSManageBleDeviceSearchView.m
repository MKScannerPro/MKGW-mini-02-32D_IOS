//
//  MKCSManageBleDeviceSearchView.m
...
@interface MKCSManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCSManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCSManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCSManageBleDeviceSearchView *view = [[MKCSManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKGatewayMiniTwo", @"MKCSManageBleDeviceSearchView", @"cs_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKGatewayMiniTwo", @"MKCSManageBleDeviceSearchView", @"cs_wifiGraySignalIcon.png");
    }
