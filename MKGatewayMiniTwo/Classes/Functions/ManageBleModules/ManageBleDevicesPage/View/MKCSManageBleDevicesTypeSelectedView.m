//
//  MKCSManageBleDevicesTypeSelectedView.m
...
@interface MKCSManageBleDevicesTypeSelectedView ()<UIGestureRecognizerDelegate,
UITableViewDelegate,
UITableViewDataSource,
MKCSManageBleDevicesTypeSelectedCellDelegate>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, copy)void (^selectedBlock)(MKCSManageBleDevicesTypeSelectedViewType selectedType);

@property (nonatomic, assign)MKCSManageBleDevicesTypeSelectedViewType selectedType;

@end

@implementation MKCSManageBleDevicesTypeSelectedView

- (void)dealloc{
    NSLog(@"MKCSManageBleDevicesTypeSelectedView销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKCSManageBleDevicesTypeSelectedCell *cell = [MKCSManageBleDevicesTypeSelectedCell initCellWithTableView:tableView];
...
#pragma mark - MKCSManageBleDevicesTypeSelectedCellDelegate
- (void)cs_manageBleDevicesTypeSelectedCell_selected:(BOOL)selected index:(NSInteger)index {
    self.selectedType = index;
    for (NSInteger i = 0; i < self.dataList.count; i ++) {
        MKCSManageBleDevicesTypeSelectedCellModel *cellModel = self.dataList[i];
...
+ (void)showWithType:(MKCSManageBleDevicesTypeSelectedViewType)type
    ...
    MKCSManageBleDevicesTypeSelectedView *view = [[MKCSManageBleDevicesTypeSelectedView alloc] init];
...
- (void)loadSectionDatas {
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel1 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel1.index = 0;
    cellModel1.selected = (self.selectedType == 0);
    cellModel1.msg = @"BXP-B-D";
    [self.dataList addObject:cellModel1];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel2 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel2.index = 1;
    cellModel2.selected = (self.selectedType == 1);
    cellModel2.msg = @"BXP-B-CR";
    [self.dataList addObject:cellModel2];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel3 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel3.index = 2;
    cellModel3.selected = (self.selectedType == 2);
    cellModel3.msg = @"BXP-C";
    [self.dataList addObject:cellModel3];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel4 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel4.index = 3;
    cellModel4.selected = (self.selectedType == 3);
    cellModel4.msg = @"BXP-D";
    [self.dataList addObject:cellModel4];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel5 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel5.index = 4;
    cellModel5.selected = (self.selectedType == 4);
    cellModel5.msg = @"BXP-T";
    [self.dataList addObject:cellModel5];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel6 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel6.index = 5;
    cellModel6.selected = (self.selectedType == 5);
    cellModel6.msg = @"BXP-S";
    [self.dataList addObject:cellModel6];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel7 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel7.index = 6;
    cellModel7.selected = (self.selectedType == 6);
    cellModel7.msg = @"MK PIR";
    [self.dataList addObject:cellModel7];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel8 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel8.index = 7;
    cellModel8.selected = (self.selectedType == 7);
    cellModel8.msg = @"MK TOF";
    [self.dataList addObject:cellModel8];
    
    MKCSManageBleDevicesTypeSelectedCellModel *cellModel9 = [[MKCSManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel9.index = 8;
