//
//  MKCSManageBleDevicesController.m
...
@interface MKCSManageBleDevicesController ()<UITableViewDelegate,
...
@implementation MKCSManageBleDevicesController

- (void)dealloc {
    NSLog(@"MKCSManageBleDevicesController销毁");
