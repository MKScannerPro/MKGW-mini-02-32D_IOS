...
@implementation MKCSBXPSAdvNormalCellModel

- (CGFloat)fetchCellHeight {
    if (self.slotType == MKCSBXPSAdvNormalCellSlotTypeNoData) {
        return 44.f;
    }
    return 150.f;
}
...
@interface MKCSBXPSAdvNormalCell ()
...
@implementation MKCSBXPSAdvNormalCell

+ (MKCSBXPSAdvNormalCell *)initCellWithTableView:(UITableView *)tableView {
    MKCSBXPSAdvNormalCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCSBXPSAdvNormalCellIdenty"];
    if (!cell) {
        cell = [[MKCSBXPSAdvNormalCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCSBXPSAdvNormalCellIdenty"];
    }
    return cell;
}
...
- (void)layoutSubviews {
    ...
    if (self.dataModel.slotType == MKCSBXPSAdvNormalCellSlotTypeNoData) {
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cs_BXPSAdvNormalCell_setPressed:interval:txPower:)]) {
        [self.delegate cs_BXPSAdvNormalCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKCSBXPSAdvNormalCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCSBXPSAdvNormalCellModel.class]) {
        return;
    }
    ...
    if (_dataModel.slotType == MKCSBXPSAdvNormalCellSlotTypeNoData) {
...
- (NSString *)getSlotTypeString:(MKCSBXPSAdvNormalCellSlotType)slotType {
    if (slotType == MKCSBXPSAdvNormalCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKCSBXPSAdvNormalCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKCSBXPSAdvNormalCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKCSBXPSAdvNormalCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKCSBXPSAdvNormalCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
    if (slotType == MKCSBXPSAdvNormalCellSlotTypeTHInfo) {
        return @"T&H info";
    }
