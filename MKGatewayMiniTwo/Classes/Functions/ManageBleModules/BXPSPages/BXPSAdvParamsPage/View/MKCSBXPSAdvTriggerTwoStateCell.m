//
//  MKCSBXPSAdvTriggerTwoStateCell.m
...
@implementation MKCSBXPSAdvTriggerTwoStateCellModel
...
@interface MKCSBXPSAdvTriggerTwoStateCell ()
...
@implementation MKCSBXPSAdvTriggerTwoStateCell

+ (MKCSBXPSAdvTriggerTwoStateCell *)initCellWithTableView:(UITableView *)tableView {
    MKCSBXPSAdvTriggerTwoStateCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCSBXPSAdvTriggerTwoStateCellIdenty"];
    if (!cell) {
        cell = [[MKCSBXPSAdvTriggerTwoStateCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCSBXPSAdvTriggerTwoStateCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cs_BXPSAdvTriggerTwoStateCell_setPressed:beforeInterval:beforeTxPower:afterInterval:afterTxPower:)]) {
        [self.delegate cs_BXPSAdvTriggerTwoStateCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKCSBXPSAdvTriggerTwoStateCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCSBXPSAdvTriggerTwoStateCellModel.class]) {
        return;
    }
...
- (NSString *)getSlotTypeString:(MKCSBXPSAdvTriggerTwoStateCellSlotType)slotType {
    if (slotType == MKCSBXPSAdvTriggerTwoStateCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKCSBXPSAdvTriggerTwoStateCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKCSBXPSAdvTriggerTwoStateCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKCSBXPSAdvTriggerTwoStateCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKCSBXPSAdvTriggerTwoStateCellSlotTypeTHInfo) {
        return @"T&H info";
    }
    if (slotType == MKCSBXPSAdvTriggerTwoStateCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
