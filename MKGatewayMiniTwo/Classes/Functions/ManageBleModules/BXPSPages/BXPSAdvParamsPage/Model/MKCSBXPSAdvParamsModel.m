...
@interface MKCSBXPSAdvParamsModel ()
...
@implementation MKCSBXPSAdvParamsModel
...
- (BOOL)readBXPSAdvParams:(NSString *)bleMac {
    ...
    [MKCSMQTTInterface cs_readBXPSAdvParamsWithBleMacAddress:bleMac macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
