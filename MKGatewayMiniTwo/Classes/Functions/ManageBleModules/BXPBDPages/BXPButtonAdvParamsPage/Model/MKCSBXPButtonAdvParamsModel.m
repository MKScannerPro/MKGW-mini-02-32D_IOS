...
@interface MKCSBXPButtonAdvParamsModel ()
...
@implementation MKCSBXPButtonAdvParamsModel
...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKCSMQTTInterface cs_bxpBtnReadAdvParamsWithBleMac:bleMac macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
