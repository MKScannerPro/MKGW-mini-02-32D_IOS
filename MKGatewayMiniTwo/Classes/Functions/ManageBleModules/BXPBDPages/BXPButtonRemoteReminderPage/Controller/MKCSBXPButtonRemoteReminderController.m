//
//  MKCSBXPButtonRemoteReminderController.m
...
@interface MKCSBXPButtonRemoteReminderController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCSBXPButtonRemoteReminderModel *dataModel;

@end

@implementation MKCSBXPButtonRemoteReminderController

- (void)dealloc {
    NSLog(@"MKCSBXPButtonRemoteReminderController销毁");
}
...
- (void)reminderLED {
    ...
    [MKCSMQTTInterface cs_bxpBtnLedRemoteReminderWithBleMac:self.bleMac blinkingTime:[self.dataModel.blinkingTime integerValue] blinkingInterval:[self.dataModel.blinkingInterval integerValue] macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (MKCSBXPButtonRemoteReminderModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSBXPButtonRemoteReminderModel alloc] init];
    }
    return _dataModel;
}
