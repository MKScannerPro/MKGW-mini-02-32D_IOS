...
@interface MKCSBXPTAccParamsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCSBXPTAccParamsModel *dataModel;

@end

@implementation MKCSBXPTAccParamsController

- (void)dealloc {
    NSLog(@"MKCSBXPTAccParamsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniTwo", @"MKCSBXPTAccParamsController", @"cs_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCSBXPTAccParamsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCSBXPTAccParamsModel alloc] init];
    }
    return _dataModel;
}
