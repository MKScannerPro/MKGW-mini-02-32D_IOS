//
//  MKCSBXPTMotionEventController.m
...
@interface MKCSBXPTMotionEventController ()<UITableViewDelegate,
...
@implementation MKCSBXPTMotionEventController

- (void)dealloc {
    NSLog(@"MKCSBXPTMotionEventController销毁");
}
...
- (void)cs_pressEventCountCell_clearButtonPressed:(NSInteger)index {
    ...
    [MKCSMQTTInterface cs_clearBXPTMotioEventCountWithBleMacAddress:self.bleMac macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (void)readDatasFromDevice {
    ...
    [MKCSMQTTInterface cs_readBXPTMotioEventCountWithBleMacAddress:self.bleMac macAddress:[MKCSDeviceModeManager shared].macAddress topic:[MKCSDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
