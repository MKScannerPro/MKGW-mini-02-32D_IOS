//
//  MKCSConnectedDeviceWriteAlertView.m
...
@interface MKCSConnectedDeviceWriteAlertView ()
...
@implementation MKCSConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKCSConnectedDeviceWriteAlertView销毁");
}
