...
static MKCSUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKCSUserLoginManager ()
...
+ (MKCSUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKCSUserLoginManager new];
        }
    });
    return loginManager;
}
