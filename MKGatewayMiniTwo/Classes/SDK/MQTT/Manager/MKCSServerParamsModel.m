...
static NSString *const fileName = @"MKCSServerParams.txt";

@interface MKCSServerParamsModel ()
...
@implementation MKCSServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCSServerParamsProtocol>)protocol {
