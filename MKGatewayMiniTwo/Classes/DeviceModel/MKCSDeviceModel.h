...
typedef NS_ENUM(NSInteger, MKCSDeviceModelState) {
    MKCSDeviceModelStateOffline,
    MKCSDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKCSDeviceModelOfflineNotification;

@protocol MKCSDeviceModelDelegate <NSObject>
...
@interface MKCSDeviceModel : NSObject<MKCSDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKCSDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKCSDeviceModelDelegate>delegate;
