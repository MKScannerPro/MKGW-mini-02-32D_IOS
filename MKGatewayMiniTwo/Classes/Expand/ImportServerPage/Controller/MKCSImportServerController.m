...
@interface MKCSImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCSImportServerController

- (void)dealloc {
    NSLog(@"MKCSImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(cs_selectedServerParams:)]) {
        [self.delegate cs_selectedServerParams:model.leftMsg];
    }
