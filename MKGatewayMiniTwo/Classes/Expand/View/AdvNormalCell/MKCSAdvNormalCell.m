...
@implementation MKCSAdvNormalCellModel
@end

@interface MKCSAdvNormalCell ()
...
@implementation MKCSAdvNormalCell

+ (MKCSAdvNormalCell *)initCellWithTableView:(UITableView *)tableView {
    MKCSAdvNormalCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCSAdvNormalCellIdenty"];
    if (!cell) {
        cell = [[MKCSAdvNormalCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCSAdvNormalCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cs_advNormalCell_setPressed:interval:txPower:)]) {
...
#pragma mark - setter
- (void)setDataModel:(MKCSAdvNormalCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCSAdvNormalCellModel.class]) {
        return;
    }
