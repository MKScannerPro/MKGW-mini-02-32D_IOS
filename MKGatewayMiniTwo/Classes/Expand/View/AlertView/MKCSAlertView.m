...
@implementation MKCSAlertViewModel
@end

@interface MKCSAlertView ()
...
@implementation MKCSAlertView

- (void)dealloc {
    NSLog(@"MKCSAlertView销毁");
}
...
- (void)showWithModel:(MKCSAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKCSAlertViewModel.class]) {
        return;
    }
