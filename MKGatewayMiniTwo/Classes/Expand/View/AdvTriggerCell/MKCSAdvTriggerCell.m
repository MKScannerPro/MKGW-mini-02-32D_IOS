...
@implementation MKCSAdvTriggerCellModel
@end

@interface MKCSAdvTriggerCell ()
...
@implementation MKCSAdvTriggerCell

+ (MKCSAdvTriggerCell *)initCellWithTableView:(UITableView *)tableView {
    MKCSAdvTriggerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCSAdvTriggerCellIdenty"];
    if (!cell) {
        cell = [[MKCSAdvTriggerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCSAdvTriggerCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cs_advTriggerCell_setPressed:interval:txPower:)]) {
        [self.delegate cs_advTriggerCell_setPressed:self.dataModel.index
...
#pragma mark - setter
- (void)setDataModel:(MKCSAdvTriggerCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCSAdvTriggerCellModel.class]) {
        return;
    }
