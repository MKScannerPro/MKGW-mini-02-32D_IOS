...
@interface MKCSAdvTriggerTwoStateCellModel : NSObject
...
@protocol MKCSAdvTriggerTwoStateCellDelegate <NSObject>
...
@interface MKCSAdvTriggerTwoStateCell : MKBaseCell

@property (nonatomic, weak)id <MKCSAdvTriggerTwoStateCellDelegate>delegate;

@property (nonatomic, strong)MKCSAdvTriggerTwoStateCellModel *dataModel;
